...
if(0<=ap_angle &&ap_angle<22.5){
  best_sector=1;
}else if (22.5<=ap_angle &&ap_angle<45){
    best_sector=2;
}else if (45<=ap_angle &&ap_angle<67.5){
    best_sector=3;
}else if (67.5<=ap_angle &&ap_angle<90){
    best_sector=4;
}else if (90<=ap_angle &&ap_angle<=112.5){
    best_sector=5;
}else if (112.5<=ap_angle &&ap_angle<=135){
    best_sector=6;
}else if (135<=ap_angle &&ap_angle<=157.5){
    best_sector=7;
}else if (157.5<=ap_angle &&ap_angle<=180){
    best_sector=8;
}else if (180<=ap_angle &&ap_angle<=202.5){
    best_sector=9;
}else if (202.5<=ap_angle &&ap_angle<=225){
    best_sector=10;
}else if (225<=ap_angle &&ap_angle<=247.5){
    best_sector=11;
}else if (247.5<=ap_angle &&ap_angle<=270){
    best_sector=12;
}else if (270<=ap_angle &&ap_angle<=292.5){
    best_sector=13;
}else if (315<=ap_angle &&ap_angle<=337.5){
    best_sector=14;
}else if (337.5<=ap_angle &&ap_angle<=360){
    best_sector=15;
}
